...
const portfolio = {
  ...
  projects: [
    ...
    { category: "crawler", number: "07", title: "我的云音乐", description: "爬虫采集到的音乐制作的仿网易云风格在线音乐播放器，支持歌单切换、播放控制、进度拖拽与歌词展示。", tags: ["JavaScript", "Audio API", "UI Design"], link: "Portfolio/开阳云音乐网站.html", accent: "blue", bgImage: "Portfolio/bgimgs/开阳云音乐.png" },
    ...
    { category: "creative", number: "12", title: "老师的Python 自我介绍 RAP 舞台", description: "赛博朋克风格的说唱舞台页面，用霓虹视效和节拍动画呈现 Python 学习旅程，支持键盘互动与光效切换。", tags: ["HTML5", "CSS3", "Animation"], link: "Portfolio/RAP舞台_HTML外化展示.html", accent: "mint", bgImage: "Portfolio/bgimgs/Python RAP舞台.png" },
